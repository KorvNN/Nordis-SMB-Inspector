...
const FINDING_RULE_LABELS = {
  ...
  "xml-secret-element": "XML içindeki kimlik bilgisi",
  "url-query-secret": "URL sorgusundaki gizli değer",
  "age-secret-key": "Age özel anahtarı",
  ...
  "npm-auth-token-assignment": "npm kayıt deposu tokenı",
  "kubernetes-client-key-data": "Kubernetes istemci özel anahtarı",
  "terraform-cloud-token": "Terraform Cloud tokenı",
  ...
  "windows-autologon-password": "Windows otomatik oturum parolası",
  "windows-unattend-password": "Windows katılımsız kurulum parolası",
  "powershell-plaintext-password": "PowerShell düz metin parolası",
  "windows-lsa-secret": "Windows LSA veya DPAPI sırrı",
  "rdp-password-blob": "RDP korumalı parola değeri",
  "windows-command-password": "Windows komut satırı parolası",
