...
const LANGUAGE_TEXT = {
  en: {
    ...
    "project_codename, internal marker": "project_codename, internal marker",
    ...
    "Veri kalıplarını açın veya en az bir özel terim girin.": "Enable data patterns or enter at least one custom term.",
