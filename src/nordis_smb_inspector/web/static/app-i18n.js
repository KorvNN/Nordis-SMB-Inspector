...
const LANGUAGE_TEXT = {
  en: {
    ...
    "SMB ve AD yazma erişimini test et": "Test SMB and AD write access",
    "AD'de desteklenen alanlara LDAP yazma isteği gönderilir; kalıcı değişiklik yapılmaz.": "AD sends LDAP write requests to supported attributes without making a persistent change.",
